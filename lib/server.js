...
// @TODO : read how the https works as compared to http and what key.pem and cert.pem are
...
/*
	@TODO
	-> what is a string decoder? what is utf-8? how does it log incoming payloads to a buffer?
	-> what is a favicon? how do you use it?
	-> explain headers. what kind of information is given/required by headers?
*/
...
server.unifiedServer = function(req,res){
	...
	req.on('end',function(){
		...
		chosenHandler(data,function(statusCode,payload,contentType){
			...
			if(statusCode == 200) {
				console.log('\x1b[32m%s\x1b[0m',method.toUpperCase()+' /'+trimmedPath+' '+ 'statusCode : [' + statusCode + ']');
			} else {
				console.log('\x1b[34m%s\x1b[0m',method.toUpperCase()+' /'+trimmedPath+' ' + 'statusCode : [' + statusCode + ']');
			}
...
server.router = {
	...
	'api/tokensCleanup' : handlers.tokensCleanup,
